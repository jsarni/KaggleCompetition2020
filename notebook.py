...
prepare_test_images_ids('//DESKTOP-ETHLFR1/j/dataset/iwildcam2020_test_information.json', '../pickeled_dataset/test_images_ids.csv')


def read_test_image_to_pickle(image_id):
    image_path_root = '{}{}.*'.format('//DESKTOP-ETHLFR1/j/dataset/test/', image_id)
...
for image in images_ids[nb_images:]:
    nb_images += 1
